...
- **MiliUI Manager for Windows** — recommended way to install/update the runtime;
- **MiliUI IntelliSense for VS Code** — optional editor autocomplete, hover information, and type hints.

The release also contains the production runtime for manual installation.
...
See [MiliUI IntelliSense](IntelliSense.md) for installation and troubleshooting.
